	  ...
	  ?>
	  				<table width="100%" border="0" cellpadding="0"  cellspacing="0" bgcolor="#EBECF0">				
						<tr HEIGHT=25>
								...
								<td  >	
								<select id="Company"  name = "Company" onchange="jsphp_shtml('Menu_1','db_reps_ranking_classes_ajax.php','company_id='+document.frmDraw.Company.options[document.frmDraw.Company.selectedIndex].value);" >									
								<?PHP
