...
if (!empty($_GET['get_msg'])) $myCart->create_message($_GET['get_msg']); // this will create a message after the script is redirected and the setting SHOW_CONTINUE = false
