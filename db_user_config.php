...
//define("DB_NAME", "subla528_signature");
//define ("DB_USER", "root");
...
define("USER_TABLE", DB_NAME.".cart_users"); 
...
define("LOGIN_PAGE", "db_user_login.php");
define("START_PAGE", "db_cart_checkout_register.php");
define("ACTIVE_PASS_PAGE", "db_user_activate_password.php");
define("DENY_ACCESS_PAGE", "/db_user_deny_access.php");
define("ADMIN_PAGE", "db_user_admin.php");
// your path must be related to the site root.
 
// change this constants to the right mail settings
define("WEBMASTER_MAIL", "shopping@signaturefundraising.com"); 
define("WEBMASTER_NAME", "Signature Fundraising Shopping Cart"); 
define("ADMIN_MAIL", "shopping@signaturefundraising.com"); 
define("ADMIN_NAME", "Signature Fundraising inc."); 

// change this vars if you need...
define("PW_LENGTH", 4);
define("LOGIN_LENGTH", 4);
