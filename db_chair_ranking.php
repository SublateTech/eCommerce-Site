<?php 
	...
	$_SESSION['sql'] = sprintf("SELECT  o.ID, o.Student, Nro_Items as NoItems, o.Retail, o.Teacher FROM Orders o Where  o.CompanyID='%s' And o.CustomerID='%s' And Nro_Items>='%d'", $_SESSION['Company'], $_SESSION['Customer'], 0);
	...
	if (!isset($_SESSION['Customer']))
		...
		exit;
			...
			$conn->showTable_ranking($rows);
			$conn->pageFooter($page,"db_chair_ranking.php");
			...
			function pattern_top($Title="School Sellers")
				{
				?>
