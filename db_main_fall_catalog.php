...
if (!session_id()) session_start();
			...
			?>  <table style="margin-top:30px"	  height="468" width="100%" bgcolor="#FFFFFF"> 
				<tr>
					<td  colspan="4">
					<div id='center_title'>
					<font size="+1">  FALL BROCHURE </font>
					</div>
					</td>
				</tr>	
					...
					<tr valign="top">
                      ...
                      <td height="240"  align = "CENTER" ><p><font style="font-size:14px"><b>
                              <a href="view/db_main_view_fall.php" target="_new"><img src="images/fall_brochure.jpg" width="433" height="215" border="0"></a>
</b></font></p>
                        <p><FONT face="Geneva, Arial, Helvetica, san-serif" color=#993300 size=2><br>
                        Click image to view our new Fall 2008 Catalog!</FONT></p>
                      </td>
  ...
  <a href="db_main_fund_form.php">Click here </a>for more information regarding our <b>Fall 2008 Catalog Fundraiser</b> or call us at <b>1-800-645-3863.</b><br>
  <br>
				      <?php //<p><font color="#990000">To shop for items included in this Catalog/Brochure please <a href="#">click here</a>.</font></p> ?>
				      </td>
  </tr>
				</table>
			<?php
