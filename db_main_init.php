...
class Content
	{
		...
		function Header_Center()
			...
			<tr  border="0" bgcolor="ffffff"  >	<!-- Middle Part -->
									...
									<?php if ($this->menu) { ?>
										<td valign="top"  bgcolor="#FFFFFF" width="150px">
																				
										
											<?php  
												//require("db_cart_leftmenu.php"); //Old Fashion
												require_once('db_main_menu.php');   
												$menu = new cart_menu();
												$menu->left_menu();
											?> 
			...
			?>
				...
				<?php
					...
					if ( $browser [0] == 6 || ($browser[0]==5 && $browser[1]=='7.0'))
			  			echo '<td style="padding-right:7.5px;" align="left" bgcolor="#FFFFFF" valign="top" width="120px">';
					else
