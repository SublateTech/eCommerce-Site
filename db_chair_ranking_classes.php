<?php 
	...
	$_SESSION['sql'] = sprintf("SELECT  o.ID, o.Student, Sum(Nro_Items) as Nro_Items, o.Retail, o.Teacher FROM Orders o Where  o.CompanyID='%s' And o.CustomerID='%s' Group By o.Teacher ", $_SESSION['Company'], $_SESSION['Customer']);
	...
	if (!isset($_SESSION['Customer']))
		...
		exit;
			...
			$conn->showTable_ranking_classes($rows);
			$conn->pageFooter($page,"db_chair_ranking_classes.php");
